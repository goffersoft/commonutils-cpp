...
extern int list_test_main(int argc, const char **argv);
extern int alloc_test_main(int argc, const char **argv);
extern int boost_test_main(int argc, const char **argv);
