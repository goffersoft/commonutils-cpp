...
template <typename K> class HashFunctionAdd;
template <typename K> class HashFunctionXor;
template <typename K> class HashFunctionRot;
template <typename K> class HashFunctionBernstein;
template <typename K> class HashFunctionBernsteinXor;
template <typename K> class HashFunctionShiftAddXor;
template <typename K> class HashFunctionFNV;
template <typename K> class HashFunctionOAT;
...
class HashFunction {
  public:
    ...
    static const HashFunctionBernstein<K>& hash_function_bernstein;
    static const HashFunctionBernsteinXor<K>& hash_function_bernstein_xor;
    static const HashFunctionShiftAddXor<K>& hash_function_shift_add_xor;
    static const HashFunctionFNV<K>& hash_function_fnv;
    static const HashFunctionOAT<K>& hash_function_oat;
...
template <typename K>
const HashFunctionAdd<K>&
HashFunction<K>::
hash_function_add = *new HashFunctionAdd<K>();

template <typename K>
const HashFunctionXor<K>&
HashFunction<K>::
hash_function_xor = *new HashFunctionXor<K>();

template <typename K>
const HashFunctionRot<K>&
HashFunction<K>::
hash_function_rot = *new HashFunctionRot<K>();

template <typename K>
const HashFunctionBernstein<K>&
HashFunction<K>::
hash_function_bernstein = *new HashFunctionBernstein<K>();

template <typename K>
const HashFunctionBernsteinXor<K>&
HashFunction<K>::
hash_function_bernstein_xor = *new HashFunctionBernsteinXor<K>();

template <typename K>
const HashFunctionShiftAddXor<K>&
HashFunction<K>::
hash_function_shift_add_xor = *new HashFunctionShiftAddXor<K>();

template <typename K>
const HashFunctionFNV<K>&
HashFunction<K>::
hash_function_fnv = *new HashFunctionFNV<K>();

template <typename K>
const HashFunctionOAT<K>&
HashFunction<K>::
hash_function_oat = *new HashFunctionOAT<K>();

template <typename K>
const HashFunctionJSW<K>&
HashFunction<K>::
hash_function_jsw = *new HashFunctionJSW<K>();

template <typename K>
const HashFunctionELF<K>&
HashFunction<K>::
hash_function_elf = *new HashFunctionELF<K>();

template <typename K>
const HashFunctionJenkins<K>&
HashFunction<K>::
